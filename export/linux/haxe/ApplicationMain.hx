...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("Rover Roamer", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("Rover Roamer", null, 640, 480);
		#end
		#else
		create (null);
		#end
	...
	public static function create (config):Void {
		...
		app.meta["file"] = "Rover Roamer";
		app.meta["name"] = "Rover Roamer";
